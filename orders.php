...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        <td style='width: 390px;'>" . $row["description"] . "</td>
    ...
    if(isset($_POST['order']) && $_POST['availability2'] == "Available"){
        ...
        $sql = "INSERT INTO `orders`(`product_id`, `users_id`, `order_quantity`, `total_price`, `date_ordered`, `status`) VALUES ('$product_id', '$users_id', '$order_quantity', '$total_price', '$date_ordered', '$status')";
